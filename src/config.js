...
export const T = {
  en:{search:'Search series, discourses…',continueListening:'Continue Listening',exploreTopic:'Explore by Topic',allSeries:'All Series',all:'All',episodes:n=>`${n} ep`,searchEp:'Search episodes…',nowPlaying:'Now Playing',back:'Series',left:'left',discEn:'English',discHi:'Hindi',discourseLang:'Discourses in',noSeries:'No series match your filters.',noEpisodes:'No episodes match your search.',linkCopied:'Link copied',footerNote:'Shared freely for the whole community — no cost, ever.',footerAttribution:'Audio and imagery are sourced from the Osho public archive.',discoursesTab:'Discourses',videosTab:'Videos',booksTab:'Books',searchVideos:'Search video discourses…',searchBooks:'Search books, authors…',videosIn:'Videos in',noVideos:'No videos match your filters.',noBooks:'No books match your filters.',allBooks:'Books',format:'Format',readComingSoon:'Reading in-app is coming soon',savedBooksEmpty:'No saved books yet — tap the heart on any book to save it here.',genres:{zen:'Zen',meditation:'Meditation',tantra:'Tantra',sufism:'Sufism',yoga:'Yoga',buddha:'Buddha',kabir:'Kabir',tao:'Tao',upanishads:'Upanishads',western:'Western Mystics',baul:'Baul Mystics',jewish:'Jewish Mystics',jesus:'Jesus',responses:'Q & A',talks:'Talks',indianmystics:'Indian Mystics',misc:'Other'}},
  hi:{search:'श्रृंखला खोजें…',continueListening:'सुनना जारी रखें',exploreTopic:'विषय के अनुसार',allSeries:'सभी श्रृंखलाएं',all:'सभी',episodes:n=>`${n} प्रवचन`,searchEp:'प्रवचन खोजें…',nowPlaying:'अभी चल रहा है',back:'श्रृंखला',left:'शेष',discEn:'अंग्रेज़ी',discHi:'हिन्दी',discourseLang:'प्रवचन भाषा',noSeries:'आपके फ़िल्टर से कोई श्रृंखला मेल नहीं खाती।',noEpisodes:'आपकी खोज से कोई प्रवचन मेल नहीं खाता।',linkCopied:'लिंक कॉपी हुआ',footerNote:'पूरे समुदाय के लिए निःशुल्क उपलब्ध — सदैव मुफ़्त।',footerAttribution:'ऑडियो और छवियाँ ओशो के सार्वजनिक संग्रह से प्राप्त हैं।',discoursesTab:'प्रवचन',videosTab:'वीडियो',booksTab:'पुस्तकें',searchVideos:'वीडियो प्रवचन खोजें…',searchBooks:'पुस्तकें खोजें…',videosIn:'वीडियो भाषा',noVideos:'आपके फ़िल्टर से कोई वीडियो मेल नहीं खाता।',noBooks:'आपके फ़िल्टर से कोई पुस्तक मेल नहीं खाती।',allBooks:'पुस्तकें',format:'प्रारूप',readComingSoon:'पढ़ने की सुविधा जल्द ही उपलब्ध होगी',savedBooksEmpty:'अभी तक कोई पुस्तक सहेजी नहीं गई — किसी भी पुस्तक पर दिल के निशान पर टैप करें।',genres:{zen:'ज़ेन',meditation:'ध्यान',tantra:'तंत्र',sufism:'सूफ़ीवाद',yoga:'योग',buddha:'बुद्ध',kabir:'कबीर',tao:'ताओ',upanishads:'उपनिषद',western:'पश्चिमी रहस्यवाद',baul:'बाउल संत',jewish:'यहूदी रहस्यवाद',jesus:'यीशु',responses:'प्रश्न-उत्तर',talks:'वार्ता',indianmystics:'भारतीय रहस्यवादी',misc:'अन्य'}},
  bn:{search:'সিরিজ খুঁজুন…',continueListening:'শোনা চালিয়ে যান',exploreTopic:'বিষয় অনুযায়ী',allSeries:'সব সিরিজ',all:'সব',episodes:n=>`${n} টি`,searchEp:'প্রবচন খুঁজুন…',nowPlaying:'এখন বাজছে',back:'সিরিজ',left:'বাকি',discEn:'ইংরেজি',discHi:'হিন্দি',discourseLang:'প্রবচন ভাষা',noSeries:'আপনার ফিল্টারের সাথে কোনো সিরিজ মেলেনি।',noEpisodes:'আপনার খোঁজার সাথে কোনো আলোচনা মেলেনি।',linkCopied:'লিঙ্ক কপি হয়েছে',footerNote:'সমগ্র সম্প্রদায়ের জন্য নিঃখরচায় উপলব্ধ — সবসময় বিনামূল্যে।',footerAttribution:'অডিও এবং ছবি ওশোর সর্বজনীন আর্কাইভ থেকে নেওয়া।',discoursesTab:'প্রবচন',videosTab:'ভিডিও',booksTab:'বই',searchVideos:'ভিডিও প্রবচন খুঁজুন…',searchBooks:'বই খুঁজুন…',videosIn:'ভিডিও ভাষা',noVideos:'আপনার ফিল্টারের সাথে কোনো ভিডিও মেলেনি।',noBooks:'আপনার ফিল্টারের সাথে কোনো বই মেলেনি।',allBooks:'বই',format:'ফরম্যাট',readComingSoon:'পড়ার সুবিধা শীঘ্রই আসছে',savedBooksEmpty:'এখনও কোনো বই সংরক্ষণ করা হয়নি — যেকোনো বইয়ের হৃদয় আইকনে ট্যাপ করুন।',genres:{zen:'জেন',meditation:'ধ্যান',tantra:'তন্ত্র',sufism:'সুফিবাদ',yoga:'যোগ',buddha:'বুদ্ধ',kabir:'কবির',tao:'তাও',upanishads:'উপনিষদ',western:'পশ্চিমা রহস্যবাদ',baul:'বাউল সাধক',jewish:'ইহুদি রহস্যবাদ',jesus:'যিশু',responses:'প্রশ্নোত্তর',talks:'আলোচনা',indianmystics:'ভারতীয় রহস্যবাদী',misc:'অন্যান্য'}},
};
...
export const GENRE_COLORS = {
  ...
  jesus:'#CBBEB2',responses:'#BBADA9',talks:'#BFB4BC',indianmystics:'#C4A98F',misc:'#C2BAB4',
};

export const GENRE_LIST = ['all','zen','meditation','tantra','sufism','yoga','buddha','kabir','tao','upanishads','western','baul','jewish','jesus','talks','responses','indianmystics'];
...
export const EPISODE_COUNTS = {en: 2912, hi: 2390};

/* ── Book format chip colours ── */
export const BOOK_FORMAT_COLORS = {PDF:'#C8AFAF', EPUB:'#B9AEA6'};

/* Video series identifiers are prefixed 'Video' so audio/video pools never collide,
   and so the pool a saved/history entry belongs to can be derived without extra state */
export const isVideoId = id => id.startsWith('Video');
